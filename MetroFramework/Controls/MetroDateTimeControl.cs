...
{
    public partial class MetroDateTimeControl : MetroUserControl
    {
        ...
        private string m_szDateEntryFormat = "dd/MM/yyyy";
        private string m_szDateDisplayFormat = "dd/MM/yyyy";
            ...
            set
            {
                ...
                else
                {
                    if (IsDateValid(value) == IsDateValidResult.Valid)
                    {
                        ...
                        {
                            txtDate.Text = GBLMethods.FormatDate(GBLMethods.CDate(value, m_szCombinedDisplayFormat),
                                m_szCombinedDisplayFormat);                            
                        }
                        else if (!DesignMode)
        ...
        public MetroDateTimeControl()
        {
            ...
            ValidateTimeFormat();
            SetDateTimeEntryPattern();
            //txtDate.Text=GBLMethods.FormatDate(DateTime.Today, m_szCombinedEntryFormat);
        }
        private void ValidateDateFormat()
        {
            ...
            if (bValid)
            {
                ...
                //Non-numeric date format strings dddd and MMMM--> becomes dd/MM/yyyy string.
                if (m_szDateEntryFormat.Contains("dddd") || m_szDateEntryFormat.Contains("MMMM"))
                    m_szDateEntryFormat = "dd/MM/yyyy";
        ...
        {
            m_wndCalendar.Hide();
            m_ctlCalendar_DateChanged(sender, e);
            txtDate.Focus();
        }
    ...
    internal class DateSegment
    {
        ...
        protected MetroTextBox m_txtDate = null;
        protected char m_cChar = '0';
        protected MetroDateTimeControl m_ctlControl = null;
        protected char m_cFormatChar = 'M';

        public DateSegment(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
        {
    ...
    {
        public DateSegmentMonth(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
    ...
    {
        public DateSegmentDay(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
            : base(ctlControl, cChar, nSegmentStart, nSegmentEnd, txtDate, cFormatChar)
        {
        }
        public override bool SegmentProcessChar()
    ...
    {
        public DateSegmentYear(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
            : base(ctlControl, cChar, nSegmentStart, nSegmentEnd, txtDate, cFormatChar)
        {
        }
        public override bool SegmentProcessChar()
    ...
    {
        public DateSegmentHour(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
            : base(ctlControl, cChar, nSegmentStart, nSegmentEnd, txtDate, cFormatChar)
        {
        }
        public override bool SegmentProcessChar()
    ...
    {
        public DateSegmentMinuteSecond(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
            : base(ctlControl, cChar, nSegmentStart, nSegmentEnd, txtDate, cFormatChar)
        {
        }
        public override bool SegmentProcessChar()
    ...
    {
        public DateSegmentAMPM(MetroDateTimeControl ctlControl, char cChar, int nSegmentStart, int nSegmentEnd, MetroTextBox txtDate, char cFormatChar)
            : base(ctlControl, cChar, nSegmentStart, nSegmentEnd, txtDate, cFormatChar)
        {
        }
        public override bool SegmentProcessChar()
    ...
    internal class GBLMethods
    {
        ...
        {
            return CDate(szValue, "dd/MM/yyyy");
        }
